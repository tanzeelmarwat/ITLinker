...
public class Constants {
    ...
    public static String FRAGMENT_CAMPUS = "CampusFragment";
    public static String FRAGMENT_FACULTY = "FacultyFragment";
    public static String FRAGMENT_STAFF = "StaffFragment";
    public static String FRAGMENT_PROFILE = "ProfileFragment";
